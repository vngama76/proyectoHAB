...
async function sumUserPoints(id_user) {
    ...
    FROM (
      ...
      select count(*) * 10 as puntos from answers where id_user = ? and id_answer_father is null 

      UNION 

      select count(*) * 5 as puntos from answers where id_user = ? and id_answer_father is not null 
