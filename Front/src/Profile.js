...
function Profile() {
  ...
  return (
    <div className="profile">
      <div className="profile-title">Tu perfil</div>
      ...
      {res && (
        <>
          ...
          <div className="pencil-container">
            <div className="user-points" title="Puntuación de Usuario">
              {userPoints} puntos
            </div>
            {rol === 'admin' && Number(q) !== id_user && (
              <>
                <button onClick={HandleBlock} className="admin-button">
                  {res.isVerify ? 'Bloquear Usuario' : 'Desbloquear Usuario'}
                </button>

                {res.rol === 'user' && (
                  <button onClick={HandlePromote} className="admin-button">
                    Promover a Experto
                  </button>
                )}
              </>
